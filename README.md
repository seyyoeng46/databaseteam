...
이 앱은 **루틴 + 투두 + 일기를 하나로 통합**하여 인지 부담을 최소화하고 AI를 사용해 실행력을 높이는 것을 목표로 합니다.

**⭐️ AI를 사용해 ADHD에게 필요한 과업 분해를 타겟으로 한 점에서 충분히 '참신한', '차별성 있는' ADHD를 위한 루틴, 투두 앱입니다. ⭐️**
